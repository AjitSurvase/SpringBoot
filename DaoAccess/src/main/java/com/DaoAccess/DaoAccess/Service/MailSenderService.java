...
public class MailSenderService {
    ...
    public void sendemail(String to)
	 {
		 String from="ajitsurvase71@gmail.com";
    ...
    public void htmlmail1(String to, String name) throws MessagingException
	 {
               ...
               <table width="600" style="background-color: #ffffff; padding: 30px; border: 1px solid #dddddd; border-radius: 8px;">
                   ...
                   <tr>
                       <td style="padding-top: 20px;">
                           ...
                           <p style="color: #555555;">Best Regards,<br>The [Unique System skills] Team</p>
                       </td>
                   </tr>

                   <tr>
                       <td style="padding-top: 20px; border-top: 1px solid #eeeeee; font-size: 12px; color: #999999; text-align: center;">
                           <p style="margin: 0;">&copy; 2025 Unique System skills. All rights reserved.</p>
